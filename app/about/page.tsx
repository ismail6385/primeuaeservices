...
export default function AboutPage() {
  return (
    <>
      <Hero
        subtitle="About Us"
        title="Your Trusted Partner in UAE"
        description="Delivering exceptional visa and PRO services with integrity, expertise, and dedication since 2008. Licensed, certified, and committed to your success."
